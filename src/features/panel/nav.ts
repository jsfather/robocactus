...
export const SUPER_ADMIN_NAV_GROUPS: PanelNavGroup[] = [
  ...
  {
    id: 'competitions',
    titleKey: 'panel.nav.competitions',
    matchPrefix: '/super-admin',
    items: [
      { to: '/super-admin/leagues', labelKey: 'competitions.nav', helpKey: 'panel.help.sa.leagues' },
      { to: '/super-admin/competition-settings', labelKey: 'competitionSettings.title', helpKey: 'panel.help.sa.leagues' },
  ...
  {
    id: 'participants',
    titleKey: 'panel.nav.participants',
    matchPrefix: '/super-admin',
    items: [
...
export const STAFF_NAV: PanelNavGroup = {
  ...
  items: [
    ...
    { to: '/staff/triage', labelKey: 'staff.tabTriage', helpKey: 'panel.help.sa.triage', permissionKey: 'account_activation' },
