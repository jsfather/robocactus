...
export function PublicHeader() {
  ...
  return <div className="pointer-events-none fixed inset-x-0 top-0 z-50 bg-transparent">
    ...
    <span className="absolute inset-x-0 top-0 hidden h-11 bg-gradient-to-l from-[#087eb8] via-[#078a9b] to-[#0b9b65] lg:block" aria-hidden="true" />
    <header ref={headerRef} className="pointer-events-auto relative mx-auto max-w-7xl bg-transparent px-2 sm:px-4 lg:px-5">
      <div className="hidden h-11 items-center justify-between px-3 text-white lg:flex">
