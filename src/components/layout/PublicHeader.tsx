...
export function PublicHeader() {
  ...
  return <div className="pointer-events-none fixed inset-x-0 top-0 z-50 bg-transparent">
    ...
    <header ref={headerRef} className="pointer-events-auto relative mx-auto max-w-7xl bg-transparent px-2 sm:px-4 lg:px-5">
      <div className="hidden h-11 items-center justify-between rounded-t-[1.4rem] bg-gradient-to-l from-[#087eb8] via-[#078a9b] to-[#0b9b65] px-4 text-white shadow-[0_8px_26px_rgb(8_126_145/0.16)] lg:flex">
        <HeaderSearch expanded />
        <div className="flex h-full items-center gap-4 text-xs text-white/90 [&_button]:border-white/20 [&_button]:bg-white/15 [&_button]:text-white [&_button:hover]:bg-white [&_button:hover]:text-rc-blue [&_a]:text-white [&_span]:border-white/25">
      ...
      <div className="flex h-[4.25rem] items-center rounded-b-2xl border border-t-0 border-white/80 bg-white/95 px-1 shadow-[0_10px_35px_rgb(15_65_80/0.12)] backdrop-blur-xl lg:rounded-b-[1.4rem]">
      ...
      <div onMouseEnter={openMega} onMouseLeave={closeMega} className={`absolute inset-x-5 top-full pt-2 transition duration-200 motion-reduce:transition-none ${megaOpen ? 'visible translate-y-0 opacity-100' : 'invisible -translate-y-2 opacity-0'}`}>
