...
export function LeaguesPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-sky-50/70 via-white to-emerald-50/30"><section className="relative overflow-hidden bg-gradient-to-l from-[#087eb8] to-[#0ca36a] px-4 pb-20 pt-28 text-white lg:pt-40"><div className="absolute -end-24 -top-24 size-80 rounded-full border-[55px] border-white/10" /><div className="relative mx-auto max-w-7xl sm:px-4"><p className="text-sm font-bold text-emerald-100">{i18n.language === 'en' ? 'Tabarestan Cup competitions' : 'مسابقات جام تبرستان'}</p><h1 className="mt-3 text-4xl font-black sm:text-6xl">{i18n.language === 'en' ? 'Choose your league' : 'لیگ خودت را انتخاب کن'}</h1><p className="mt-5 max-w-2xl text-base leading-8 text-white/75">{i18n.language === 'en' ? 'Explore active leagues, find the right competition for your team, and prepare for national and international challenges.' : 'از میان لیگ‌های فعال، رشته متناسب با توانایی تیم خود را پیدا کنید و برای حضور در رقابت‌های ملی و بین‌المللی آماده شوید.'}</p></div></section><div className="relative mx-auto -mt-10 max-w-7xl px-4 pb-24 sm:px-8">
