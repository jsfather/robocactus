...
export function AnnouncementPage() {
  ...
  if (!item) return <div className="mx-auto max-w-3xl px-4 pb-20 pt-40 text-center"><p className="font-black text-red-600">{t('content.postNotFound')}</p><Link to="/news" className="mt-5 inline-flex text-sky-700">{t('content.announcementsTitle')}</Link></div>
