...
export function CompaniesPage() {
  ...
  return (
    <div className="pb-20"><section className="bg-gradient-to-br from-[#063d59] via-[#087eb8] to-[#087a58] px-4 pb-20 pt-28 text-white lg:pt-40"><div className="mx-auto max-w-6xl"><p className="text-xs font-black tracking-[.22em] text-cyan-200">PARTICIPANT DIRECTORY</p><div className="mt-3 flex flex-wrap items-end justify-between gap-5"><div><h1 className="text-4xl font-black sm:text-6xl">{t('companies.title')}</h1><p className="mt-4 max-w-2xl text-sm leading-7 text-white/75">{t('companies.subtitle')}</p></div><div className="rounded-2xl bg-white/10 px-5 py-3 text-center backdrop-blur"><strong className="block text-3xl">{companies.length.toLocaleString('fa-IR')}</strong><span className="text-xs text-white/70">پروفایل فعال</span></div></div></div></section><main className="mx-auto -mt-9 max-w-6xl space-y-6 px-4">
