...
export function BlogListPage() {
  ...
  return <main className="min-h-screen overflow-hidden bg-[#f6fafb] pb-20">
    <section className="relative overflow-hidden bg-[#062f46] text-white">
      ...
      <div className="relative mx-auto grid max-w-7xl gap-10 px-4 pb-16 pt-28 sm:px-8 sm:pb-20 sm:pt-36 lg:grid-cols-[1.02fr_.98fr] lg:items-center lg:gap-16 lg:pt-40">
