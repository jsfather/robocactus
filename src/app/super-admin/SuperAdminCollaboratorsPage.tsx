...
export function SuperAdminCollaboratorsPage() {
  ...
  const reload = async () => {
    const [nextProfiles, nextLeagues, nextAssignments] = await Promise.all([fetchAllProfiles(), fetchAllLeagues(), fetchLeagueAdmins()])
